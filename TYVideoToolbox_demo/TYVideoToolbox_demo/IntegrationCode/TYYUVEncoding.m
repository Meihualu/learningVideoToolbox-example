...
//   TYYUVEncoding *encoder = (__bridge TYYUVEncoding *)(outputCallbackRefCon);
//    
//    //判断是否编码成功
//    if (status != noErr) {
...
//    OSStatus status = VTCompressionSessionCreate(NULL, width, height, kCMVideoCodecType_H264, NULL, NULL, NULL, vtCompressionSessionCallback, (__bridge void * _Nullable)(self), &_vEnSession);
//    if (status == noErr) {
//        // 设置参数
...
//        // 设置码率
//        VTSessionSetProperty(_vEnSession, kVTCompressionPropertyKey_AverageBitRate, (__bridge CFTypeRef)@(100000));
//        // 设置实时编码
...
//    int width = 640, height = 480;
//    //视频宽度
//    size_t pixelWidth = width;
//    //视频高度
//    size_t pixelHeight = height;
//    
